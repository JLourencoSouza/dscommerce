...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<ProdutcDTO> insert(@RequestBody ProdutcDTO dto){
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<ProdutcDTO> update(@PathVariable Long id,@RequestBody ProdutcDTO dto ){
